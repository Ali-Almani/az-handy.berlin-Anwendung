      ...
      >
        ...
        >
          ...
          <ul className="navbar-mobile-nav">
            {navLinks}
            {user ? (
              <li className="navbar-avatar-container navbar-avatar-container--mobile" ref={mobileDropdownRef}>
                <button
                  onClick={toggleDropdown}
                  className="navbar-avatar-btn"
                  aria-label="Benutzermenü"
                >
                  ...
                  {hasReminderBadge && (
                    <span
                      className="navbar-avatar-badge"
                      title="Erinnerung: Verlauf prüfen"
                      onClick={(e) => { e.stopPropagation(); handleOpenVerlauf(); closeMobileMenu(); }}
                      role="button"
                      tabIndex={0}
                    >
                      {reminderCount > 9 ? '9+' : reminderCount}
                  ...
                  {hasExtraCopyBadge && (
                    <span
                      className="navbar-avatar-badge navbar-avatar-badge--extra"
                      onClick={(e) => { e.stopPropagation(); handleOpenExtraCopyModal(); closeMobileMenu(); }}
                      role="button"
                      tabIndex={0}
                    >
                      {extraCopyCount > 9 ? '9+' : extraCopyCount}
                  ...
                  {hasExtraCopyResultBadge && (
                    <span
                      className="navbar-avatar-badge navbar-avatar-badge--result"
                      onClick={(e) => { e.stopPropagation(); handleOpenExtraCopyResultModal(); closeMobileMenu(); }}
                      role="button"
                      tabIndex={0}
                    >
                      {extraCopyResultCount > 9 ? '9+' : extraCopyResultCount}
                  ...
                  {hasReminderResponseBadge && (
                    <span
                      className="navbar-avatar-badge navbar-avatar-badge--reminder-response"
                      onClick={(e) => { e.stopPropagation(); handleOpenReminderResponseModal(); closeMobileMenu(); }}
                      role="button"
                      tabIndex={0}
                    >
                      {reminderResponseCount > 9 ? '9+' : reminderResponseCount}
